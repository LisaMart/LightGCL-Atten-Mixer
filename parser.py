...
def parse_args():
    ...
    parser.add_argument('--data', default='diginetica', type=str, help='name of dataset - diginetica, yoochoose1_64')
    ...
    parser.add_argument('--max_users', type=int, default=50000, help='max users to keep (None = all)')  # None
    parser.add_argument('--max_items', type=int, default=100000, help='max items to keep (None = all)')  # None
